...
public class GeneticAlgorithm<I extends Individual, P extends Problem<I>> {
    ...
    private SelectionMethod<I, P> selection;
    private Recombination<I> recombination;
    ...
    public I run(P problem) {
        ...
        while(!stopCondition(t)) {
            ...
            //evaluate(P(t+1))
            I bestInGeneration = population.evaluate();
            bestInRun = (bestInGeneration.fitness > bestInRun.fitness) ? (I) bestInGeneration.clone() : bestInRun;
            t++;
